...
tellraw @s ["",{"text": "[ ","color":"white","bold":true,"click_event": {"action": "run_command", "command": "/function keep_inventory_orbs:menu/getallmine"}},{"text":"COLLECT","color":"gold","bold":true,"click_event": {"action": "run_command", "command": "/function keep_inventory_orbs:menu/getallmine"}},{"text":" ALL MY ","bold":true,"click_event": {"action": "run_command", "command": "/function keep_inventory_orbs:menu/getallmine"}},{"text":"ORBS ","color":"aqua","bold":true,"click_event": {"action": "run_command", "command": "/function keep_inventory_orbs:menu/getallmine"}},{"text":"]","bold":true,"click_event": {"action": "run_command", "command": "/function keep_inventory_orbs:menu/getallmine"}},{"text":"              "},{"text":"RECOVERY COMPASS","color":"dark_purple","bold":true}]
tellraw @s ""
execute if score c kio.newDeath matches 0 run tellraw @s ["",{"text":"                     ","bold":true},{"text":"                       |","color":"white"},"       ",{"text":"  ","bold":true},{"text":"[ OFF ]","bold":true,"color":"gray","click_event": {"action": "run_command", "command": "/function keep_inventory_orbs:menu/togglecompass"}},{"text":"          |","color":"white"}]
execute if score c kio.newDeath matches 1 run tellraw @s ["",{"text":"                     ","bold":true},{"text":"                       |","color":"white"},"   ",{"text":"      ","bold":true},{"text":"[ ON ]","bold":true,"color":"white","click_event": {"action": "run_command", "command": "/function keep_inventory_orbs:menu/togglecompass"}},{"text":"   ","bold":true},{"text":"       |","color":"white"}]
...
execute if score s kio.newDeath matches 0 run tellraw @s ["",{"text":"                     ","bold":true},{"text":"                       |","color":"red"},"       ",{"text":"  ","bold":true},{"text":"[ OFF ]","bold":true,"color":"gray","click_event": {"action": "run_command", "command": "/function keep_inventory_orbs:menu/togglestealing"}},{"text":"          |","color":"red"}]
execute if score s kio.newDeath matches 1 run tellraw @s ["",{"text":"                     ","bold":true},{"text":"                       |","color":"red"},"   ",{"text":"      ","bold":true},{"text":"[ ON ]","bold":true,"color":"red","click_event": {"action": "run_command", "command": "/function keep_inventory_orbs:menu/togglestealing"}},{"text":"   ","bold":true},{"text":"       |","color":"red"}]
